package com.message.android.messages;
 ...
 public class AutoCompleteAdopter  extends AutoCompleteTextView {
     private String previous = "";
     private String seperator = ";";
     public AutoCompleteAdopter(final Context context, final AttributeSet attrs, final int defStyle) {
         super(context, attrs, defStyle);
         this.setThreshold(0);
     }
     public AutoCompleteAdopter(final Context context, final AttributeSet attrs) {
         super(context, attrs);
         this.setThreshold(0);
     }
     public AutoCompleteAdopter(final Context context) {
         super(context);
         this.setThreshold(0);
     }
